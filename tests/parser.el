...
(js2-deftest parse-export-bindings "{one, two as dos}"
  ...
  (let ((imports (js2-parse-export-bindings)))
    ...
    (let ((first (nth 0 imports))
      ...
      (should (equal "one" (js2-name-node-name (js2-export-binding-node-local-name first))))
      (should (equal "two" (js2-name-node-name (js2-export-binding-node-local-name second))))
      (let ((first-name (js2-export-binding-node-extern-name first))
            (second-name (js2-export-binding-node-extern-name second)))
...
(js2-deftest parse-export-binding-as-default "one as default"
  ...
  (let ((binding (js2-maybe-parse-export-binding)))
    ...
    (let ((name (js2-export-binding-node-extern-name binding)))
      (should name)
